...
from gpflow.models.model import InputData, RegressionData, MeanAndVariance

import sys
sys.path.append("/home/fwq/PycharmProjects/my_code_cpu/t-SVGP/")
from src.sites import DiagSites
from src.util import posterior_from_dense_site_white, project_diag_sites, posterior_from_dense_site
from gpflow.models.training_mixins import InternalDataTrainingLossMixin

class t_SVGP_sites(GPModel, InternalDataTrainingLossMixin):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._init_variational_parameters(self.num_data, lambda_1, lambda_2)  # lambda_1: (self.num_data, self.num_latent_gps), lambda_2: (self.num_data, self.num_latent_gps)
    ...
    def get_mean_chol_cov_inducing_posterior(self):
        ...
        lambda_1, lambda_2 = project_diag_sites(K_uf, self.lambda_1, self.lambda_2, K_uu, cholesky=True)  # (None, 1), (1, None, None)
        temp_q_mu, temp_q_sqrt = posterior_from_dense_site(K_uu, lambda_1, lambda_2)   # (M, 1), (1, M, M)

        return temp_q_mu, temp_q_sqrt
