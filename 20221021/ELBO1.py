...
plt.plot(np.linspace(0.1, 5, nit), elbo_mean[0, :][:], "r-o", label=names[0])
plt.plot(np.linspace(0.1, 5, nit), elbo_mean[1, :][:], "b-d", label=names[1])
plt.plot(np.linspace(0.1, 5, nit), elbo_mean[2, :][:], "k-D", label=names[2])
# plt.xlim([0,1])
plt.legend()
